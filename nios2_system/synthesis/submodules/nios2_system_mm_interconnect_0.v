...
module nios2_system_mm_interconnect_0 (
	...
	wire   [24:0] led_red_s1_agent_m0_address;                                               // led_red_s1_agent:m0_address -> led_red_s1_translator:uav_address
	...
	wire  [103:0] led_red_s1_agent_rf_source_data;                                           // led_red_s1_agent:rf_source_data -> led_red_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] led_red_s1_agent_rsp_fifo_out_data;                                        // led_red_s1_agent_rsp_fifo:out_data -> led_red_s1_agent:rf_sink_data
	...
	wire          cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> led_red_s1_agent:cp_valid
	wire  [102:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> led_red_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                     // led_red_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> led_red_s1_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> led_red_s1_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> led_red_s1_agent:cp_endofpacket
	...
	wire   [24:0] led_green_s1_agent_m0_address;                                             // led_green_s1_agent:m0_address -> led_green_s1_translator:uav_address
	...
	wire  [103:0] led_green_s1_agent_rf_source_data;                                         // led_green_s1_agent:rf_source_data -> led_green_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] led_green_s1_agent_rsp_fifo_out_data;                                      // led_green_s1_agent_rsp_fifo:out_data -> led_green_s1_agent:rf_sink_data
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> led_green_s1_agent:cp_valid
	wire  [102:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> led_green_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // led_green_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> led_green_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> led_green_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> led_green_s1_agent:cp_endofpacket
	...
	wire          led_red_s1_agent_rp_valid;                                                 // led_red_s1_agent:rp_valid -> router_012:sink_valid
	wire  [102:0] led_red_s1_agent_rp_data;                                                  // led_red_s1_agent:rp_data -> router_012:sink_data
	wire          led_red_s1_agent_rp_ready;                                                 // router_012:sink_ready -> led_red_s1_agent:rp_ready
	wire          led_red_s1_agent_rp_startofpacket;                                         // led_red_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          led_red_s1_agent_rp_endofpacket;                                           // led_red_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          led_green_s1_agent_rp_valid;                                               // led_green_s1_agent:rp_valid -> router_013:sink_valid
	wire  [102:0] led_green_s1_agent_rp_data;                                                // led_green_s1_agent:rp_data -> router_013:sink_data
	wire          led_green_s1_agent_rp_ready;                                               // router_013:sink_ready -> led_green_s1_agent:rp_ready
	wire          led_green_s1_agent_rp_startofpacket;                                       // led_green_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          led_green_s1_agent_rp_endofpacket;                                         // led_green_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          led_red_s1_agent_rdata_fifo_src_valid;                                     // led_red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] led_red_s1_agent_rdata_fifo_src_data;                                      // led_red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          led_red_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_010:in_0_ready -> led_red_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                         // avalon_st_adapter_010:out_0_valid -> led_red_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                          // avalon_st_adapter_010:out_0_data -> led_red_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                         // led_red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                         // avalon_st_adapter_010:out_0_error -> led_red_s1_agent:rdata_fifo_sink_error
	wire          led_green_s1_agent_rdata_fifo_src_valid;                                   // led_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] led_green_s1_agent_rdata_fifo_src_data;                                    // led_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          led_green_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_011:in_0_ready -> led_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> led_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> led_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // led_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> led_green_s1_agent:rdata_fifo_sink_error
